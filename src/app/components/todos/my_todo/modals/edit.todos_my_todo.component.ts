...
/**
 * Modal dialog for editing your existing My_todo entity types, and/or
 * creating new entity types of type My_todo.
 */
@Component({
  templateUrl: './edit.todos_my_todo.component.html'
})
export class EditTodos_my_todoComponent extends DialogComponent {

  /**
   * Constructor taking a bunch of services injected using dependency injection.
   */
  constructor(
    public dialogRef: MatDialogRef<EditTodos_my_todoComponent>,
    @Inject(MAT_DIALOG_DATA) public data: DialogData,
    protected snackBar: MatSnackBar,
    public service: HttpService) {
    super(snackBar);
    this.primaryKeys = ['todo_id'];
    this.createColumns = [
      'title',
      'description',
      'due_data',
    ...
    const datesToFormat: string[] = ['due_data'];
  ...
  protected getUpdateMethod() {
    return this.service.todos_my_todo.update(this.data.entity);
  }
  /**
   * Returns a reference to the create method, to create new entities.
   */
  protected getCreateMethod() {
    return this.service.todos_my_todo.create(this.data.entity);
  }
